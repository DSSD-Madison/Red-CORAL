...
const CategoryControl: React.FC<YearControlProps> = ({ filters, setFilters }) => {
  ...
  const CategoryContent = () => (
    <>
      <div className={`${isMobile ? 'w-full text-sm' : 'leaflet-bar box-content w-60 rounded bg-tint-02/80 shadow-lg backdrop-blur-sm'}`}>
      ...
      {/* Event Subtypes */}
      <div className={`${isMobile ? 'w-full text-sm' : 'leaflet-bar box-content w-80 rounded bg-tint-02/80 shadow-lg backdrop-blur-sm'}`}>
